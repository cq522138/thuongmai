                ...
                <div class="col-sm-6">
                    <div class="contactinfo">
                        <ul class="nav nav-pills">
                            <li><a href="#"><i class="fa fa-phone"></i> 0947772368</a></li>
                            <li><a href="#"><i class="fa fa-envelope"></i> tuanlinhvu1991@gmail.com</a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-sm-6">
...
<footer id="footer"><!--Footer-->
    ...
    <div class="footer-bottom">
        <div class="container">
            <div class="row">
                <p class="pull-left">Copyright Vũ Tuấn Linh. All rights reserved.</p>
                <p class="pull-right">Designed by <span><a target="_blank"
                                                           href="https://www.facebook.com/vutuanlinh.1991">Vũ Tuấn Linh</a></span>
                </p>
            </div>
        </div>
    </div>
